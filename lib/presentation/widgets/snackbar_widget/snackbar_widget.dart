...
class SnackBarWidget<T extends Object> extends GetBar {
  final String? title;
  final SnackBarType type;
  TopSnackBarStatusCallBack? onStatusChanged;

  SnackBarWidget(
      {Key? key,this.title, this.type = SnackBarType.error})
...
class _TopSnackBarState<K extends Object> extends State<SnackBarWidget>
